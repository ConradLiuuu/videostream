...
*/
    ...
    if ((center.x == 0) && (center.y == 0)){
      ...
      ball_center.data.push_back((float)cnt_proc);
      ...
      if ((center.x >0) && (center_in_world_frame.x < 1848) && (center.y > 0) && (center_in_world_frame.y < 1336)){
