...
{
  ros::init(argc, argv, "findcontour2020");
  ros::NodeHandle nh;
  ...
  // Read image
  std::string path = "/home/lab606a/dic/right/right551_1582598015.110063.jpg";
  img = imread(path);

  Mat drawing = imread("/home/lab606a/dic/right/right551_1582598015.110063.jpg");
...
*/
  ...
  inRange(img, Scalar(10, 85, 250), Scalar(30, 255, 255), img);
  //Canny( img, canny_img, thresh, thresh*2, 3 );
